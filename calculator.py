...
btn_multiply = Button(root, text="*", font=("ariel", 12, "bold"), bd=12, height=2, width=6, command=lambda:btnClick(X))
btn_multiply.grid(row=3, column=3)
btn_can = Button(root, text="c", font=("ariel", 12, "bold"), bd=12, height=2, width=6, command=btnClear)
btn_can.grid(row=4, column=0)
...
btn_equal = Button(root, text="=", font=("ariel", 12, "bold"), bd=12, height=2, width=6,command=btnEquals )#command=lambda:btnClick("=") )
